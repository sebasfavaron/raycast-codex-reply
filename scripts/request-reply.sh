...
PROMPT_PATH="${BRIDGE_DIR}/current-prompt.json"
REPLY_PATH="${BRIDGE_DIR}/reply.json"
DEFAULT_DEEPLINK="raycast://extensions/sebas/raycast-codex-reply/reply-to-codex"
DEEPLINK="${RAYCAST_CODEX_REPLY_DEEPLINK:-$DEFAULT_DEEPLINK}"
